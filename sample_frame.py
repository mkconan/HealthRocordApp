...
def create_input_frame(container):
    ...
    match_case_check = ttk.Checkbutton(
        frame, text="Match case", variable=match_case, command=lambda: print(match_case.get())
    )
    ...
    wrap_around_check = ttk.Checkbutton(
        frame, variable=wrap_around, text="Wrap around", command=lambda: print(wrap_around.get())
    )
